...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
         ...
         */
        try {
            const resultBufferOne = await supplyChain.fetchItemBufferOne.call(upc, {from:anonymousID})
            assert.equal(resultBufferOne[2], consumerID, 'Error: Result returned from fetchItemBufferOne() function is incorrect when anonymous address calls it')
        } catch(error) {
            assert.fail('Error: Anonymous address cannot call fetchItemBufferOne() function')
        }
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        try {
            const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc, {from:anonymousID})
            assert.equal(resultBufferTwo[5].toNumber(), 7, 'Error: Result returned from fetchItemBufferTwo() function is incorrect when anonymous address calls it')
        } catch(error) {
            assert.fail('Error: Anonymous address cannot call fetchItemBufferTwo() function')
        }
